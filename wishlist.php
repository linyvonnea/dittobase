...
$sql = "SELECT photocards.*, members.name AS member_name, albums.album_name, albums.release_date, versions.version_name, pobs.pob_version 
        ...
        WHERE user_photocards.user_id = '$user_id' AND user_photocards.status = 'wishlist'
